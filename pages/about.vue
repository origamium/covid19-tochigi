<template>
  <div class="About">
    ...
    <StaticCard>
      {{
        $t(
          '当サイトは新型コロナウイルス感染症 (COVID-19) に関する最新情報を提供するために、東京都が開設したものを有志が栃木県向けに変更を加えたものです。'
        )
      }}<br />
      <br />
      {{
        $t(
          '東京都による公式情報と客観的な数値をわかりやすく伝えることで、栃木県にお住まいの方や、栃木内に拠点を持つ企業の方、栃木県を訪れる方が、現状を把握して適切な対策を取れるようにすることを目的としています。'
        )
      }}
    </StaticCard>
    <StaticCard>
